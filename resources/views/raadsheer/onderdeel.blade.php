    ...
    @if($formonderdeel->leden)
        ...
        @foreach($formonderdeel->formonderdelendiscipline as $discipline)
            ...
            <div class="btn btn-group float-right">
                ...
                <a class="btn btn-danger" href="{{ route('raadsheer.discipline.destroy', ['id' => $discipline->id]) }}" onclick="event.preventDefault(); document.getElementById('deleteDiscipline-{{$discipline->id}}').submit();">Deactiveren</a>
...
{{--                                    {!! Form::label('achternaam', 'Achternaam') !!}--}}
    ...
    {{--                        {!! Form::label('type' . $vraag->id, 'Type: Als je dit aanpast worden de ingevulde antwoorden gewist! Tenzij dat er van "Tekst vraag (lang antwoord)" van of naar "Tekst vraag (kort antwoord)" wordt het wordt alleen ingekort indien nodig. ') !!}--}}
            ...
            <div class="btn btn-group float-right">
                ...
                <a class="btn btn-danger" href="{{ route('raadsheer.vraag.destroy', ['id' => $vraag->id]) }}" onclick="event.preventDefault(); document.getElementById('deleteVraag{{$vraag->id}}').submit();">Verwijderen</a>
