        ...
        @foreach($gilden as $gilde)
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    @else
                        Dit jaar nog niet ingelogd.
                    @endif
                </div>
                <div class="col-1">
                    {{ $gilde->antwoorden->count() }}/{{$vragen->count()}}
                </div>
                <div class="col-1">
                    {{   $gilde->leden->count() + 
                ...
                <div class="col-1">
                    <a href="{{route('organiser.download.gilde', ['gilde' => $gilde->id])}}" class="btn btn-secondary" download>Download</a>
                </div>
            </div>
            <hr>
        @endforeach
